...
public class MsnConnection implements  Runnable {
    ...
    String NsURL = "ms.msgrsvcs.ctsrv.gay";  // replaced with CrossTalk
    ...
    // yet nexus never used by code...


    private Msn msn;
    /**
     * The constructor method.
     * @param URL URL of the server. No protocols specified here! Example: messenger.hotmail.com.
    ...
    private boolean connectToServer() throws JimmException {
        ...
        if (msn.getServer() != "") {
            String[] userDefinedServer = Util.explode(msn.getServer(), ':');
            this.NsURL = userDefinedServer[0];
            this.serverPort = Integer.parseInt(userDefinedServer[1]);
        }
        try {
            ...
            // пиздит как дышит сука хахахаххахах
